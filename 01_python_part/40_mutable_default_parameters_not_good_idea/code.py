...
# class Student:
#     def __init__(self, name: str, grades: List[int] = []):  # This is bad! Not good with mutable default value for parameters List[int] = [] 
#       # - default value is created, created for 2 student with the same list
#         self.name = name
#         self.grades = grades

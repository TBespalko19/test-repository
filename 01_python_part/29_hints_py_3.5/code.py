...
# def list_avg(sequence: List) -> float: # python understand that this function is going to return a float
#     return sum(sequence) / len(sequence)

# list_avg(123) # Error TypeError: 'int' object is not iterable
